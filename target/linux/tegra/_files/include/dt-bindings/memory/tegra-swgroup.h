...
#define TEGRA_SWGROUP_EPP	(TEGRA_SWGROUP_NVDEC1 + 1) // 4	/* 0x248 */
#define TEGRA_SWGROUP_G2	(TEGRA_SWGROUP_NVDEC1 + 2) // 5	/* 0x24c */
// #define TEGRA_SWGROUP_HC		6	/* 0x250 */
// #define TEGRA_SWGROUP_HDA	7	/* 0x254 */
#define TEGRA_SWGROUP_ISP	TEGRA_SWGROUP_ISP2 // 8	/* 0x258 */
// #define TEGRA_SWGROUP_ISP2	8
#define TEGRA_SWGROUP_DC14	(TEGRA_SWGROUP_NVDEC1 + 3) // 9	/* 0x490 *//* Exceptional non-linear */
#define TEGRA_SWGROUP_DC12	(TEGRA_SWGROUP_NVDEC1 + 4) // 10	/* 0xa88 *//* Exceptional non-linear */
#define TEGRA_SWGROUP_MPE	TEGRA_SWGROUP_NVENC // 11	/* 0x264 */
#define TEGRA_SWGROUP_MSENC	TEGRA_SWGROUP_NVENC // 11
...
#define TEGRA_SWGROUP_SATA2	(53 + 1) // 15	/* 0x274 */
// #define TEGRA_SWGROUP_SATA	16	/* 0x278 */
#define TEGRA_SWGROUP_VDE	(53 + 2) // 17	/* 0x27c */
// #define TEGRA_SWGROUP_VI	18	/* 0x280 */
#define TEGRA_SWGROUP_VII2C	TEGRA_SWGROUP_VI // 18	/* 0x280 */
...
#define TEGRA_SWGROUP_GPUB	(53 + 3) // 31	/* 0xaac */
